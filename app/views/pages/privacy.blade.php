...
<div style="background:#FFF; padding: 30px;">
    ...
    Please also visit our Terms and Conditions section establishing the use, disclaimers, and limitations of liability governing the use of our website at www.qbrando.com<br />

    <h3>Your Consent</h3>
    By using our site, you consent to our online privacy policy.<br /><br />

    <h3>Changes to our Privacy Policy</h3>
    If we decide to change our privacy policy, we will send an email notifying you of any changes, and/or update the Privacy Policy modification date below.<br/>

    <h3>Contacting Us</h3>
    If there are any questions regarding this privacy policy you may contact us using the information below.<br />
    <a href="http://www.qbrando.com">www.qbrando.com</a><br />
    Al Nasr Street , Doha , Qatar<br />
    Doha, qatar 4524<Br />
    Doha<Br />
    support@qbrando.com
