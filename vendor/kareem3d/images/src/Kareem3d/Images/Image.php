...
class Image extends Model {
    ...
    {
        return Version::largestDim()->byImage($this)->first();
    }
    ...
    {
        return Version::smallestDim()->byImage($this)->first();
    }
    ...
    {
        return Version::nearestDim($width, $height, $lowerSize)->byImage($this)->first();
    }
    ...
    {
        return $this->hasMany(App::make('Kareem3d\Images\Version')->getClass());
    }
